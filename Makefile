...
all: arm-tf-final optee-client-final optee-examples-final mytee-examples-final bluetooth-examples-final linux-final boot-final
...
.PHONY: bluetooth-examples
bluetooth-examples:
	$(MAKE) -C ${TEE_SDK_DIR}/bluetooth_examples \
HOST_CROSS_COMPILE=${CROSS_COMPILE} \
TEEC_EXPORT=${TEE_SDK_DIR}/optee_client/out/export \
TA_DEV_KIT_DIR=${TEE_SDK_DIR}/optee_os/out/arm/export-ta_arm32

.PHONY: bluetooth-examples-final
optee-examples-final: bluetooth-examples
	cp ${TEE_SDK_DIR}/bluetooth_examples/bt_client/host/bt_client ./out/rootfs/bin/